...
- 🔐 Role-Based Authentication (Admin, User, Station, Delivery)
- ⛽ Fuel Station Approval System
- 📦 Fuel Booking & Order Tracking
...
- **Backend:** Java, Spring Boot, Spring MVC, Spring Security, Spring Data JPA, Hibernate (ORM)
...
[![Watch Demo](thumbnail.png)](https://github.com/user-attachments/assets/ca0462ec-1b9c-47c4-8362-69c91c073d91)
...
3. Configure `application.properties` and run:
   ```
